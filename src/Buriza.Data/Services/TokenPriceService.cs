    ...
    IDataServiceSessionProvider? sessionProvider = null)
{
    ...
    /// <summary>
    /// Get prices for multiple tokens in a single request (max 100)
    /// </summary>
    ...
    /// <summary>
    /// Get price for a single token (cached)
    /// </summary>
    ...
    /// <summary>
    /// Get price change percentages for a token across multiple timeframes
    /// </summary>
    ...
    /// <summary>
    /// Get ADA price in specified quote currency (USD, EUR, BTC, ETH)
    /// </summary>
