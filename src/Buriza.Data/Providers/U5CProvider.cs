...
/// <summary>
/// UTxO RPC (U5C) provider implementing ICardanoDataProvider for Chrysalis transaction building.
/// </summary>
public class U5CProvider : ICardanoDataProvider, IDisposable
{
    ...
    /// <summary>Gets the network type (Mainnet/Testnet) for this provider.</summary>
    public NetworkType NetworkType { get; }

    public U5CProvider(string endpoint, string? apiKey = null, NetworkType networkType = NetworkType.Mainnet)
    {
    ...
    {
        // TODO: Implement transaction metadata retrieval
        return Task.FromResult<CborMetadata?>(null);
    }

    #endregion

    #region Extended Methods (for IBurizaChainProvider via BurizaU5CProvider)
